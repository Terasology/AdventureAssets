...
public class SwingingBladeSTServerSystem extends BaseComponentSystem {
    ...
    /**
     * This method is used to retrieve the stored settings for each SwingingBlade once it is spawned. This method is
     * called only after the OnActivatedComponent for the {@link SwingingBladeComponent} has executed.<br/> Note: only
     * the properties of the Swinging Blade should be overwritten in the {@link SwingingBladeComponent}, since the
     * existing {@link SwingingBladeComponent} already has a list for childrenEntities (rod, blade and mesh).
     *
     * @param addSwingingBladeComponent
     * @param transformation
     */
    private void configureSwingingBlades(AddSwingingBladeComponent addSwingingBladeComponent,
    ...
    public void onBuildTemplateWithScheduledStructurePlacement(BuildStructureTemplateEntityEvent event,
        ...
        for (Vector3i position : event.findAbsolutePositionsOf(blockFamily)) {
            ...
            AddSwingingBladeComponent.SwingingBladesToSpawn swingingBladeToSpawn =
                    new AddSwingingBladeComponent.SwingingBladesToSpawn();
