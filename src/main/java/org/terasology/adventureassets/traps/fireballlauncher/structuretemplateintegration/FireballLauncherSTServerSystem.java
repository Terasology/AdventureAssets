...
public class FireballLauncherSTServerSystem extends BaseComponentSystem {
    ...
    @ReceiveEvent
    public void onSpawnTemplate(SpawnTemplateEvent event, EntityRef entity,
                                AddFireballLauncherComponent addFireballLauncherComponent) {
        configureFireballLaunchers(addFireballLauncherComponent, event.getTransformation());
    }
     ...
     */
    private void configureFireballLaunchers(AddFireballLauncherComponent addFireballLauncherComponent,
                                            BlockRegionTransform transformation) {
        for (AddFireballLauncherComponent.FireballLauncherToSpawn f :
                addFireballLauncherComponent.fireballLaunchersToSpawn) {
            ...
            fireballLauncherComponent.direction = convertDirectionToAbsolute(f.direction,
                    transformation.transformSide(Side.FRONT));
    ...
    public void onBuildTemplateWithScheduledStructurePlacement(BuildStructureTemplateEntityEvent event,
        ...
        for (Vector3i position : event.findAbsolutePositionsOf(blockFamily)) {
            ...
            FireballLauncherComponent fireballLauncherComponent =
                    blockEntity.getComponent(FireballLauncherComponent.class);
            AddFireballLauncherComponent.FireballLauncherToSpawn fireballLauncherToSpawn =
                    new AddFireballLauncherComponent.FireballLauncherToSpawn();
            ...
            fireballLauncherToSpawn.direction = convertDirectionToRelative(fireballLauncherComponent.direction,
                    transformToRelative.transformSide(Side.FRONT));
